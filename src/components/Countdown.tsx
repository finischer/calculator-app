...
const Countdown = React.forwardRef<ICountdownFunctions, ICountdownProps>(({ numOfPhases, onFinish = () => null }, ref) => {
    ...
    return (
        <View className='flex-1 flex-column justify-center items-center w-screen'>
            <View className="py-10">
                <Text className='text-slate-100 text-xl'>Phase {activePhase + 1} / {numOfPhases}</Text>
            </View>
